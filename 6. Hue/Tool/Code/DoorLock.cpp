...
CDoorLock::CDoorLock(LPDIRECT3DDEVICE9 pGraphicDev, Engine::OBJ_INFO& _tCubeInfo)
	: CObj(pGraphicDev, _tCubeInfo)
{
	m_pResourceMgr = Engine::Get_ResourceMgr();
}

CDoorLock::~CDoorLock(void)
{
	Release();
}

HRESULT CDoorLock::Initialize(void)
{
...
void CDoorLock::Update(void)
{
	SetTransform();
}

void CDoorLock::Render(void)
{
...
void CDoorLock::SetTransform(void)
{
...
HRESULT CDoorLock::AddComponent(void)
{
...
CDoorLock * CDoorLock::Create(LPDIRECT3DDEVICE9 pGraphicDev, Engine::OBJ_INFO& _tCubeInfo)
{
	CDoorLock* pInstance = new CDoorLock(pGraphicDev, _tCubeInfo);
