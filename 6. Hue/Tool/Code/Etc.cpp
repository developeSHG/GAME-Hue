...
CEtc::CEtc(LPDIRECT3DDEVICE9 pGraphicDev, Engine::OBJ_INFO& _tCubeInfo)
...
HRESULT CEtc::AddComponent(void)
{
...
CEtc * CEtc::Create(LPDIRECT3DDEVICE9 pGraphicDev, Engine::OBJ_INFO& _tCubeInfo)
{
	CEtc* pInstance = new CEtc(pGraphicDev, _tCubeInfo);
