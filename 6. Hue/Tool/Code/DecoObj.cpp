...
CDecoObj::CDecoObj(LPDIRECT3DDEVICE9 pGraphicDev, Engine::OBJ_INFO& _tCubeInfo)
	: CObj(pGraphicDev, _tCubeInfo)
{
	m_pResourceMgr = Engine::Get_ResourceMgr();
}

CDecoObj::~CDecoObj(void)
{
	Release();
}

HRESULT CDecoObj::Initialize(void)
{
...
void CDecoObj::Update(void)
{
	SetTransform();
}

void CDecoObj::Render(void)
{
...
void CDecoObj::SetTransform(void)
{
...
HRESULT CDecoObj::AddComponent(void)
{
...
CDecoObj * CDecoObj::Create(LPDIRECT3DDEVICE9 pGraphicDev, Engine::OBJ_INFO& _tCubeInfo)
{
	CDecoObj* pInstance = new CDecoObj(pGraphicDev, _tCubeInfo);
