...
Engine::CRcMouse::CRcMouse(LPDIRECT3DDEVICE9 pGraphicDev)
	: CVIBuffer(pGraphicDev)
{

}

Engine::CRcMouse::~CRcMouse(void)
{
	Release();
}

HRESULT Engine::CRcMouse::CreateBuffer(void)
{
...
void Engine::CRcMouse::Render(void)
{
	CVIBuffer::Render();
}

void Engine::CRcMouse::Release(void)
{

}

CRcMouse* Engine::CRcMouse::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CRcMouse*		pInstance = new CRcMouse(pGraphicDev);
