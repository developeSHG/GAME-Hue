...
CBackKeyBoard::CBackKeyBoard(LPDIRECT3DDEVICE9 pGraphicDev)
	: CGameObject(pGraphicDev)
{
	m_pResourceMgr = Engine::Get_ResourceMgr();
}

CBackKeyBoard::~CBackKeyBoard(void)
{
	Release();
}

HRESULT CBackKeyBoard::Initialize(void)
{
	...
	m_pTexName = L"Texture_BackKeyBoard";
	...
	m_pInfoCom->m_vScale = D3DXVECTOR3(1.8f, 0.5f, 1.f);

	m_pInfoCom->m_vPos.x =  0.f;
	m_pInfoCom->m_vPos.y = -3.05f;
	m_pInfoCom->m_vPos.z =  0.3f;

	return S_OK;
}

void CBackKeyBoard::Update(void)
{
	SetTransform();
}

void CBackKeyBoard::LateUpdate(void)
{
}

void CBackKeyBoard::Render(void)
{
...
void CBackKeyBoard::Release(void)
{
	if (m_pVertex)
...
void CBackKeyBoard::SetTransform(void)
{
...
HRESULT CBackKeyBoard::AddComponent(void)
{
...
CBackKeyBoard * CBackKeyBoard::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CBackKeyBoard* pInstance = new CBackKeyBoard(pGraphicDev);
