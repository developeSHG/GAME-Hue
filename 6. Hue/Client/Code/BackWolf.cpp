...
CBackWolf::CBackWolf(LPDIRECT3DDEVICE9 pGraphicDev)
	: CGameObject(pGraphicDev)
{
	m_pResourceMgr = Engine::Get_ResourceMgr();
}

CBackWolf::~CBackWolf(void)
{
	Release();
}

HRESULT CBackWolf::Initialize(void)
{
	...
	m_pInfoCom->m_vPos.x = 1.3f;
	m_pInfoCom->m_vPos.y = -1.15f;
	m_pInfoCom->m_vPos.z = 1.2f;

	return S_OK;
}

void CBackWolf::Update(void)
{
	SetTransform();
}

void CBackWolf::LateUpdate(void)
{
}

void CBackWolf::Render(void)
{
...
void CBackWolf::SetTransform(void)
{
...
HRESULT CBackWolf::AddComponent(void)
{
...
CBackWolf * CBackWolf::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CBackWolf* pInstance = new CBackWolf(pGraphicDev);
